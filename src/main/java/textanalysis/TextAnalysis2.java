...
public class TextAnalysis2 {
    ...
    public List textCompare(StringBuffer text , Set set){
        String[] splitWords = text.toString().split("\n");
        ...
        while (iterator.hasNext()){
            ...
            for( int i = 0;i<contents.length;i++ ){
                ...
                if( lines.length > yuzhi){
                    List lineVecot = TextAnalysis2.lines2Vec(Double.parseDouble(key.toString()),lines,vec);
    ...
    public Map<Integer,String> readText(String path)throws Exception{
        ...
        while( (line=read.readLine()) != null ){
            textStringBuffer.append(TextAnalysis2.getSplitWord(line)).append("\n");
        }
